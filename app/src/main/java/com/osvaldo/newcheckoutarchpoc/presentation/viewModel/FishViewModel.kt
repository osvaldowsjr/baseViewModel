...
class FishViewModel(
    private val sandwichUseCase: SandwichUseCase, private val completionUseCase: CompletionUseCase
) : BaseViewModel<FishViewModel.ViewIntent, FishViewModel.ViewState, FishViewModel.ViewEffect, SandwichDomainModel>() {
    ...
    override fun domainFlow(): MutableStateFlow<GenericResultFlow<SandwichDomainModel>> =
